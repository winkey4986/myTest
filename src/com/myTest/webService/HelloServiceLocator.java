...
public class HelloServiceLocator extends org.apache.axis.client.Service implements com.myTest.webService.HelloService {
    ...
    private java.lang.String HelloPort_address = "http://127.0.0.1:8888/WebServiceTest/Hello";
    ...
    public com.myTest.webService.Hello getHelloPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.myTest.webService.HelloPortBindingStub _stub = new com.myTest.webService.HelloPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.myTest.webService.Hello.class.isAssignableFrom(serviceEndpointInterface)) {
                com.myTest.webService.HelloPortBindingStub _stub = new com.myTest.webService.HelloPortBindingStub(new java.net.URL(HelloPort_address), this);
                _stub.setPortName(getHelloPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webService.myTest.com/", "HelloService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webService.myTest.com/", "HelloPort"));
        }
